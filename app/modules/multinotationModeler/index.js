...
import { isPPINOTConnection } from './notations/ppinot/Types';
import { isLabelExternal, getLabel } from './notations/ppinot/utils/LabelUtil';
...
export function initMultiNotationModeler(options = {}) {
  // Create core instance, passing any BPMN modeler instance
  ...
  return {
    ...
    initialize: async () => {
      // Initialize core and return it even if there are errors
      try {
        await core.initialize();
      } catch (err) {
        console.warn('[MultiNotationModeler] Core initialization had issues:', err);
      }
      return core;
    }
  };
