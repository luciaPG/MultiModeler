...
import * as ppinotModule from './multinotationModeler/ppinot/index.js';
import * as ralphModule from './multinotationModeler/ralph/index.js';
...
export async function initializeApplication(options = {}) {
  ...
  try {
    ...
    const multiNotationModeler = initMultiNotationModeler(options);
